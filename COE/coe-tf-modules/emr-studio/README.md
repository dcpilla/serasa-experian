...
| [aws_s3_bucket.cloudformation_template_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket) | resource |
| [aws_s3_bucket_ownership_controls.cloudformation_template_access_ownership_controls_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_ownership_controls) | resource |
| [aws_s3_bucket_public_access_block.cloudformation_template_access_block_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_public_access_block) | resource |
| [aws_s3_bucket_server_side_encryption_configuration.cloudformation_template_access_encryption_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_server_side_encryption_configuration) | resource |
| [aws_s3_bucket_versioning.cloudformation_template_access_version_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_versioning) | resource |
...
| [aws_servicecatalog_principal_portfolio_association.principal_association](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/servicecatalog_principal_portfolio_association) | resource |
| [aws_servicecatalog_principal_portfolio_association.principal_association_user](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/servicecatalog_principal_portfolio_association) | resource |
| [aws_servicecatalog_product.emr](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/servicecatalog_product) | resource |
| [aws_servicecatalog_product_portfolio_association.emr_association](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/servicecatalog_product_portfolio_association) | resource |
...
| [aws_iam_role.role_admin](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_role) | data source |
...
| [template_file.cf-template-emr](https://registry.terraform.io/providers/hashicorp/template/latest/docs/data-sources/file) | data source |
...
| <a name="input_cluster_role_name"></a> [cluster\_role\_name](#input\_cluster\_role\_name) | Name to use on CloudFormation Template to be used on EMR Cluster creation in Service Catalog | `string` | `"BURoleForEMREC2DefaultRole"` | no |
...
| <a name="input_gearr_id"></a> [gearr\_id](#input\_gearr\_id) | Specifies App id or Gearr ID Experian | `string` | n/a | yes |
...
| <a name="input_s3_emr_cluster_logs"></a> [s3\_emr\_cluster\_logs](#input\_s3\_emr\_cluster\_logs) | Name to use on CloudFormation Template to be used as S3 EMR Cluster Logs in Service Catalog | `string` | n/a | yes |
...
| <a name="input_service_role_policy_name"></a> [service\_role\_policy\_name](#input\_service\_role\_policy\_name) | Name to use on IAM Policy created | `string` | `null` | no |
...
| <a name="input_user_role_policy_name"></a> [user\_role\_policy\_name](#input\_user\_role\_policy\_name) | Name to use on IAM policy created | `string` | `null` | no |
