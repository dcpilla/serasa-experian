...
eks_cluster_name = "mlops-test-10"
...
aws_auth_roles = [
  {
    rolearn  = "arn:aws:iam::294463638235:role/BURoleForSRE"
    username = "BUAdministratorAccessRole"
    groups   = ["system:masters"]
  },
  {
    rolearn  = "arn:aws:iam::294463638235:role/BURoleForDevelopersAccess"
    username = "BUAdministratorAccessRole"
    groups   = ["system:masters"]
  },
]
...
coe_argocd_helm_version          = "v1.0.0-34-gf91dcd0"
...
istio_ingress_annotation = {
  "service.beta.kubernetes.io/aws-load-balancer-ssl-cert"               = "arn:aws:acm:sa-east-1:294463638235:certificate/f3361b39-a8cc-45ed-b98b-022266aebace"
