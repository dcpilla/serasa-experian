...
# assume_role_arn         = "arn:aws:iam::628637623969:role/BURoleForDevSecOpsCockpitService"
map_server_id           = "d-server-01riktnbfe0092"
 
vpc_id = "auto"
subnets = "auto"
eks_ami_id = "latest"
repo_version = "MLCOE-Version-525-gce55944"
karpenter = "disabled"
...
istio_ingress_annotation = {
  "service.beta.kubernetes.io/aws-load-balancer-ssl-cert"               = "arn:aws:acm:sa-east-1:628637623969:certificate/41ccb53e-9b7d-4e3b-8f57-bf149a0284f2"
...
external_dns_domain_filters = [
  "dev-ecs-collection.br.experian.eeca"
]
