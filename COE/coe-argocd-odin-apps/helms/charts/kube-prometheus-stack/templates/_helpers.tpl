...
{{/* Istio gateway name */}}
{{- define "kube-prometheus-stack.istio.gateway.name" -}}
{{- printf "%s-gateway" .Chart.Name | trimSuffix "-" -}}
{{- end }}

{{/* Istio url name */}}
{{- define "kube-prometheus-stack.istio.domain" -}}
{{- printf "%s.%s" .Values.istio.domainPrefix .Values.istio.domain -}}
{{- end }}
...
{{- end -}}
{{/*
Use the Istio namespace override for multi-namespace deployments in combined charts
*/}}
{{- define "kube-prometheus-stack.istio.namespace" -}}
  {{- if .Values.istio.namespaceOverride -}}
    {{- .Values.istio.namespaceOverride -}}
  {{- else -}}
    {{- .Release.Namespace -}}
  {{- end -}}
{{- end -}}
