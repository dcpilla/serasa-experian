terraform {
  backend "s3" {
    key = "sa-east-1/elasticache/negativescache-pj-redis-v2/terraform.tfstate"
  }
}
...
locals {
  common_tags = {
    ...
    "layer"          = "gold"
    "Name"           = "negativescache-pj-redis-v2"
