terraform {
  backend "s3" {
    key = "sa-east-1/secrets-manager/sm_sftp_cerc_controlador/terraform.tfstate"
  }
}
...
module "sm_sftp_cerc_controlador" {
  ...
  name                    = "sm_sftp_cerc_controlador"
  secret_string           = "vG@2S4312v"
